        ...
        >
          ...
          <g className="coffee-steam">
            <path
              ...
              fill="none"
              stroke={loadingProgress > 70 ? highlightColor : "#D9D9D9"}
              strokeWidth="8"
              strokeLinecap="round"
            >
              <animate
            ...
            <path
              ...
              fill="none"
              stroke={loadingProgress > 80 ? highlightColor : "#D9D9D9"}
              strokeWidth="8"
              strokeLinecap="round"
              opacity="0.7"
            >
            ...
            <path
              ...
              fill="none"
              stroke={loadingProgress > 90 ? highlightColor : "#D9D9D9"}
              strokeWidth="8"
              strokeLinecap="round"
              opacity="0.8"
            >
