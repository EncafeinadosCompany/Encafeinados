                ...
                <Form {...form} >
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 ">
                        ...
                        <DialogHeader className="flex flex-col mx-auto items-center relative">
                            ...
                            <DialogTitle className="text-2xl font-bold text-[#2C1810]">Agregar nueva imagen</DialogTitle>
                    ...
                    <div className="flex flex-col items-center text-center space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <CardDescription className="text-lg text-[#6F4E37]">
                                Muestra la experiencia única de tu cafetería a través de imágenes cautivadoras
                            </CardDescription>
                            <p className="text-sm text-[#6F4E37]/70">
                                Sube fotos de tu espacio, bebidas artesanales y momentos especiales
                            </p>
                        </div>
                        <Button
