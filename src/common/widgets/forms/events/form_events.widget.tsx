...
} from "@/common/utils/schemas/events/register_events.schema";
...
export default function FormRegisterEvents() {
  ...
  function onSubmit(values: RegisterEventSchemaType) {
    const date_time_start = combineDateTime(
      values.start_date,
      values.start_time || "00:00"
    );
    const data_time_end = combineDateTime(
      values.end_date,
          ...
          <Form {...method}>
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        className="border-gray-400  rounded-md bg-gray-50 hover:border-amber-600  ring-amber-600 "
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        className="min-h-[100px] border-gray-400 rounded-md bg-gray-50 hover:border-amber-600 ring-amber-600"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <FormControl>
                              <Button
                                variant={"outline"}
                                className={`w-full pl-3 text-left font-normal border-gray-400 rounded-md bg-gray-50 hover:border-amber-600 hover:bg-gray-100 ${
              ...
              <FormField
                ...
                name="is_free"
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-md border border-gray-400 bg-gray-50 p-4 hover:border-amber-600">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Selecciona las sucursales donde se realizará el evento
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
