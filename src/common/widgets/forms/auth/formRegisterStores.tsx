                    ...
                    <CardHeader className="flex flex-col">
                        ...
                        <TitleForm
                            ...
                            subtitle={(() => {
                                switch (step) {
                                    case 0:
                                        return "Únete a nuestro club de cafeterías de especialidad, haz parte de las cafeterías de especialidad destacadas, conecta con nuevos coffeelovers y comparte tu pasión por el café.";
                                    case 1:
                                        return ""
                                    default:
                                        return "";
