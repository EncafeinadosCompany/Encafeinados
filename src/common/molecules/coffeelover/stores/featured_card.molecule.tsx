...
export default function FeaturedCard({ branches, isFeatured = false }: FeaturedCardProps) {
  ...
  return (
    <motion.div
      className={`${isFeatured ? "w-[60vh] h-80" : "w-[55vh] h-70"} transition-all duration-300`}
      whileHover={{ scale: 1.03 }}
      transition={{ type: "spring", stiffness: 300, damping: 30 }}
    >
      <Card
        className="w-full h-full overflow-hidden rounded-3xl shadow-lg border-0 cursor-pointer"
      ...
      >
        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute bottom-0 flex flex-col  justify-center items-center h-[15vh] w-full bg-black/50 backdrop-blur-sm p-4">
            <div className="w-full max-w-2xl  text-center ">
                <h3
                className="text-2xl font-light text-white mb-2 leading-tight line-clamp-2"
                style={{
                  display: '-webkit-box',
                  WebkitLineClamp: 2,
          ...
          <div className="absolute top-4 left-4">
            <div className="bg-white/80 backdrop-blur-sm text-[#5F4B32] text-sm px-3 py-1 rounded-full flex items-center gap-1 shadow-sm">
