...
export const LoginCard = (
  ...
  return (
    <div className="flex flex-col gap-5">
      <Card className="overflow-hidden rounded-xl border-none sm:border border-amber-200/50 sm:shadow-lg backdrop-blur-sm sm:bg-white/90 sm:dark:bg-gray-900 sm:dark:border-amber-800/50">
