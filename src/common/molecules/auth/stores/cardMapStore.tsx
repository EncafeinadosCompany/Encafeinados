...
export const CardMapStore = ({
  ...
  return (
    <div className="w-full max-w-3xl bg-white rounded-xl shadow-lg p-4 md:p-6 space-y-4">
      {/* Input de búsqueda */}
      ...
      {/* Mapa responsivo */}
      <div className="h-[250px] md:h-[350px] w-full rounded-lg overflow-hidden shadow-md border">
        <MapContainer
