...
const AlbumManager = () => {
  return (
    <div className="w-full h-full flex flex-col bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
      <header className="flex-shrink-0 bg-white/95 border-b border-gray-100 py-1 px-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
